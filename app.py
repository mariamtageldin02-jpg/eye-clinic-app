...
if not st.session_state.logged_in:
    ...
    st.set_page_config(
        page_title="Dr. Tag Eye Clinic Login",
        page_icon="🔐",
        layout="centered"
    )

    st.title("🔐 Dr. Tag Eye Clinic Login")
...
SUPABASE_URL = "https://gejecugcmnuqvrnrijgh.supabase.co"

SUPABASE_KEY = "sb_secret_so2Qd1nrLMuzm9UPeKAwXw_nQ_kHERT"
